      ...
      <header className="sticky top-0 z-50 border-b border-[#cbb7a2]/40 bg-[#f7f0e8]/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
          ...
          <nav className="hidden gap-8 text-sm text-[#6b5445] md:flex">
            ...
            <a href="tel:9295254083" className="transition hover:text-[#2f241d] font-medium">(929) 525-4083</a>
          </nav>
          <a
            href="#contact"
      ...
      <main>
          ...
          <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-[1.15fr_0.85fr] lg:px-10 lg:py-28">
            ...
            <div className="relative z-10 flex flex-col justify-center">
              <div className="mb-6 inline-flex w-fit items-center rounded-full border border-[#c9b19b] bg-[#fff8f1]/70 px-4 py-2 text-xs uppercase tracking-[0.24em] text-[#866956]">
                Corporate Events ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¢ Weddings ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¢ Private Events
              </div>
              ...
              <p className="mt-5 max-w-2xl text-base leading-7 text-[#6f5849] sm:text-lg md:text-xl">
                Afrobeats, Amapiano, Hip-Hop, R&amp;B, and everything in between Ã¢ÂÂ DJ Toluu reads the room and moves the crowd at corporate galas, weddings, and private celebrations. Based in Atlanta. Available nationwide.
              </p>
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                ...
                <div className="rounded-3xl border border-[#d8c2af] bg-[#fff9f3] p-5 shadow-[0_18px_40px_rgba(93,63,42,0.08)]">
                  <p className="text-3xl font-semibold">Nationwide + Travel</p>
                  <p className="mt-2 text-sm text-[#7c6657]">
            ...
            {/* Right ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ hero image */}
        ...
        >
          ...
          <div className="space-y-6 text-lg leading-8 text-[#6a5445]">
            <p>
              ...
              playlist. Every set is shaped around the room, the audience, and the momentÃÂÃÂ¢ÃÂÃÂÃÂÃÂso the
            ...
            <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-lg leading-8 text-[#6f5849]">
                  ...
                  response built around your eventÃÂÃÂ¢ÃÂÃÂÃÂÃÂnot a generic quote.
                </p>
                ...
                {status === "success" ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    >
                      ...
                      <option>50ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ100</option>
                      <option>100ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ200</option>
                      <option>200ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ500</option>
                      <option>500+</option>
                    </select>
                    <textarea
                      placeholder="Tell me about your event ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ venue, city, vibe, anything relevant"
                      rows={3}
                    ...
                    >
                      {status === "sending" ? "SendingÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¦" : "Check Availability"}
                    </button>
                    {status === "error" && (
        ...
        <footer className="border-t border-[#cbb7a2]/40 bg-[#efe2d4]">
          <div className="mx-auto flex max-w-7xl flex-col gap-3 px-6 py-6 text-sm text-[#806755] sm:flex-row sm:items-center sm:justify-between lg:px-10">
            ...
            <p>Corporate Events Â· Weddings Â· Private Events Nationwide</p>
            <a href="mailto:bookings@djtoluu.com" className="underline underline-offset-4">
              bookings@djtoluu.com
            </a>
          </div>
          <div className="mx-auto max-w-7xl px-6 py-4 text-center text-sm text-[#6b5445]">
    <a href="tel:9295254083" className="hover:text-[#2f241d] transition">(929) 525-4083</a>
  </div>
</footer>
      </main>
    </div>
